...
document.getElementById('giocatautente').innerHTML = giocata_utente;
...
document.getElementById('giocatapc').innerHTML = giocata_pc;

// chiedo all'utente pari o dispari
var pari_dispari = prompt('Ora scegli: pari o dispari?');
...
if (risultato_somma == true && pari_dispari == 'pari'){
    console.log('Hai vinto');
    document.getElementById('pari-vinto').innerHTML = 'Hai scelto pari, hai vinto!';
}

if (risultato_somma == true && pari_dispari == 'dispari') {
    console.log('Hai perso');
    document.getElementById('dispari-perso').innerHTML = 'Hai scelto dispari, hai perso! Riprova.';
}

if (risultato_somma == false && pari_dispari == 'dispari') {
    console.log('Hai vinto');
    document.getElementById('dispari-vinto').innerHTML = 'Hai scelto dispari, hai vinto!';
}

if  (risultato_somma == false && pari_dispari == 'pari') {
    console.log('Hai perso');
        document.getElementById('pari-perso').innerHTML = 'Hai scelto pari, hai perso! Riprova.';
}
